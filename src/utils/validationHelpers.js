 ...
 *
 * @example
 * // Valid password with uppercase, lowercase, number, special char
 ...
 *     // Test with 8+ chars, upper, lower, number, special
 *     const result = validatePassword('Valid123!Pass');
 ...
 *     const result = validatePassword('NoSpecial123Pass');
 *     expect(result.isValid).toBe(false);
